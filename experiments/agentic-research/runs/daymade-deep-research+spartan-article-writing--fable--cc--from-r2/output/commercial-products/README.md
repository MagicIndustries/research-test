...
Hosted, turnkey research agents from OpenAI, Google, Perplexity, and Anthropic. Highest polish, lowest setup cost, least transparency — and every performance number is vendor self-reported.
...
Launched February 14, 2025 as the only freemium option: free with a limited daily query count, unlimited for Pro; most reports complete in under 3 minutes; claimed 21.1% on Humanity's Last Exam (vendor number relayed by journalism) [13]. Exact free-tier caps and any deep-research API could not be confirmed, and these February 2025 details are likely stale by AS_OF 2026-07-18. **Confidence: Low.**
