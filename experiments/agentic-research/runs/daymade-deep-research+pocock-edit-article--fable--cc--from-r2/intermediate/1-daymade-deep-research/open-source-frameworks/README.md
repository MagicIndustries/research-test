...
Common pattern across all frameworks: supply at least one LLM API key **plus** a web-search provider key (SerpAPI/Serper/Tavily/etc.) — the main friction versus hosted products, where search and model come bundled [28][25][26][29].
